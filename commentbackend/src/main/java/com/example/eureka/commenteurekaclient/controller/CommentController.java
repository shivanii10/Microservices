...
public class CommentController {
	...
	public ResponseEntity<String> deleteComment(@RequestBody Comments comment){
		return new ResponseEntity(commentService.deleteComment(comment), HttpStatus.ACCEPTED);
	}
	@DeleteMapping("/delete/{cid}")
	public ResponseEntity<String> deleteCommentByCid(@PathVariable("cid") int cid){
		return new ResponseEntity(commentService.deleteCommentByCid(cid), HttpStatus.ACCEPTED);
	}
	@GetMapping("/pid/{pid}")
